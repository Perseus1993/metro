...
class GoalJourneyProbeResult:
    ...
    traces: tuple[GoalJourneyTraceStep, ...]
    ...
    def summary_metrics(self) -> dict[str, int]:
        return {
            ...
            "facility_service_events": int(self.movement["facility_service_events"]),
