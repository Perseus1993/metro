...
class FacilityReleaseGeometryMixin:
    """Queue-capture and body-clear release geometry shared by facilities."""
    ...
    def _safe_queue_slot(self, index: int) -> tuple[float, float]:
        ...
        except Exception:  # noqa: BLE001 - preserve the historical geometry fallback
            return slot
    ...
    def _release_position(
        ...
        *,
        ...
        for candidate in candidates:
            ...
            except Exception:  # noqa: S112, BLE001 - preserve the historical placement fallback
                continue
