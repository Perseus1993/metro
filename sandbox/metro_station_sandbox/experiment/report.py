...
def _markdown_report(summary: list[dict[str, Any]]) -> str:
    lines = [
        ...
        "",
        "| case | design | entry/h | exit/h | seed | status | completion | remaining | avg system min | max gate q | max vertical q | stuck | trajectory | replay file | issues |",
        "|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---|---|---|",
    ]
    for row in summary:
        case = row["case"]
        ...
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    str(_int(metrics.get("gate_queue_persons"))),
                    str(_int(metrics.get("vertical_queue_persons"))),
