...
- 生成时间 (UTC): 2026-08-03T11:01:04.981141+00:00
- 环境: Python 3.12.13; Torch 2.13.0+cu126; CUDA 12.6; device NVIDIA GeForce RTX 3080
- 决策: **STOP**
- 原因: P1 blocker failed (contact/geometry path is not yet trustworthy).

## 门控汇总
- 场景门: PASS
- 梯度门: PASS
- Metro boundary smoke: FAIL
- 32×300 吞吐门: FAIL
...
- 自动/黑箱 p50 最小比值: 0.41
- 达到最优比值预算: 4
- 吞吐 32×300: 553957.158342052 (P0 baseline: 997550.1830075786)
- 吞吐比: 0.5553175847974793
- 文献留出基线通过: N/A
...
| --- | ---: | ---: | ---: | ---: |
| cpu | 1 | 300 | 13,637 | — |
| cuda | 1 | 300 | 20,002 | 4.5 |
| cuda | 8 | 300 | 163,009 | 36.1 |
| cuda | 32 | 300 | 553,957 | 140.9 |
| cuda | 1 | 1024 | 88,443 | 52.1 |
