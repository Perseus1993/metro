...
- 生成时间 (UTC): 2026-08-03T14:30:35.298755+00:00
- 环境: Python 3.12.13; Torch 2.13.0+cu126; CUDA 12.6; device NVIDIA GeForce RTX 3080
- 决策: **LIMITED-GO**
- 原因: Calibration line is suspended; only throughput-capability path is preserved.
...
- 达到最优比值预算: 2
- 吞吐 32×300: 1343138.9941765706 (P0 baseline: 997550.1830075786)
- 吞吐比: 1.3464375196915446
- 文献留出基线通过: N/A
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 4 | D:\metro\experiments\torch_movement_p1\data\juelich_corridor2\txt\fd1_n14.txt | from-dataset:fd1_n14.txt (txt:juelich-person-frame-xy) | 84 | 36 | 45.4317 | 21.5349 | 0.474 | 0.616 | 5.33137 | 3.73359 |
| 6 | D:\metro\experiments\torch_movement_p1\data\juelich_corridor2\txt\fd1_n14.txt | from-dataset:fd1_n14.txt (txt:juelich-person-frame-xy) | 84 | 36 | 45.4317 | 21.5349 | 0.474 | 0.616 | 5.33137 | 3.73359 |

## 吞吐（P1-07）
| Device | Batch | Slots | Agent-step/s | Peak MiB |
| --- | ---: | ---: | ---: | ---: |
| cpu | 1 | 300 | 24,272 | — |
| cuda | 1 | 300 | 58,625 | 4.5 |
| cuda | 8 | 300 | 486,752 | 36.1 |
| cuda | 32 | 300 | 1,343,139 | 140.9 |
| cuda | 1 | 1024 | 194,864 | 52.1 |
