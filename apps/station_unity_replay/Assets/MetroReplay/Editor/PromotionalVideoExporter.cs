...
namespace MetroReplay.Editor
{
    ...
    public static class PromotionalVideoExporter
    {
        ...
        private const string MobileCommandLineArgument = "--export-promotional-mobile-video";
        ...
        private static bool _commandLinePortraitRequested;
        ...
        private static void ScheduleCommandLineExport()
        {
            ...
            _commandLinePortraitRequested = HasCommandLineArgument(MobileCommandLineArgument);
        ...
        private static void TryStartCommandLineExport()
        {
            ...
            EditorApplication.update -= TryStartCommandLineExport;
            BeginExport(_commandLinePortraitRequested);
        }
        ...
        [MenuItem("Metro Replay/视频/导出 26 秒手机竖屏宣传片 MP4", priority = 201)]
        public static void ExportMobile()
        {
            BeginExport(true);
        }

        private static void BeginExport(bool portrait)
        {
            ...
            var fileName = portrait
                ? $"PerseusMetro_MobileNative_{DateTime.Now:yyyyMMdd_HHmmss_fff}"
                : $"PerseusMetro_{DateTime.Now:yyyyMMdd_HHmmss_fff}";
            ...
            _commandLinePortraitRequested = false;
            PromotionalVideoCapture.SetActive(true, portrait);
        ...
        public static void ExportFromCommandLine()
        {
            _commandLineExportRequested = true;
            _commandLinePortraitRequested = HasCommandLineArgument(MobileCommandLineArgument);
            EditorApplication.delayCall += () => BeginExport(_commandLinePortraitRequested);
        }

        private static bool HasCommandLineExportArgument()
        {
            return HasCommandLineArgument(CommandLineArgument)
                   || HasCommandLineArgument(MobileCommandLineArgument);
        }
