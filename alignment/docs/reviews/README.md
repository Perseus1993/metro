...
2. `round_22_formal_600_acceptance.md` — first current-fingerprint formal 600-step baseline evidence, with a valid fail result;
3. `round_20_automated_all.json` — reproducible behavior/artifact checks for all three views;
4. `round_21_independent_agents.md` — independent method, Metro, and generality review of the fail-closed source contract.
